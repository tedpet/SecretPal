...
public abstract class _SPMembership extends  ERXGenericRecord {
  ...
  public static final String PERSON_KEY = PERSON.key();
	...
	private static final Logger LOG = LoggerFactory.getLogger(_SPMembership.class);
  ...
  public void setAdmin(Boolean value) {
	_SPMembership.LOG.debug( "updating admin from {} to {}", admin(), value);
  ...
  public void setConfirmationCode(String value) {
	_SPMembership.LOG.debug( "updating confirmationCode from {} to {}", confirmationCode(), value);
  ...
  public void setConfirmed(Boolean value) {
	_SPMembership.LOG.debug( "updating confirmed from {} to {}", confirmed(), value);
  ...
  public void setGroupRelationship(com.secretpal.model.SPGroup value) {
	  ...
	  _SPMembership.LOG.debug("updating group from {} to {}", group(), value);
  ...
  public void setPersonRelationship(com.secretpal.model.SPPerson value) {
	  ...
	  _SPMembership.LOG.debug("updating person from {} to {}", person(), value);
