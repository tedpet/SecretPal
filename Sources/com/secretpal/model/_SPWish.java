...
public abstract class _SPWish extends  ERXGenericRecord {
  ...
  public static final String SUGGESTED_FOR_KEY = SUGGESTED_FOR.key();
	...
	private static final Logger LOG = LoggerFactory.getLogger(_SPWish.class);
  ...
  public void setCost(java.math.BigDecimal value) {
	_SPWish.LOG.debug( "updating cost from {} to {}", cost(), value);
  ...
  public void setDescription(String value) {
	_SPWish.LOG.debug( "updating description from {} to {}", description(), value);
  ...
  public void setPurchased(Boolean value) {
	_SPWish.LOG.debug( "updating purchased from {} to {}", purchased(), value);
  ...
  public void setSuggestedByRelationship(com.secretpal.model.SPPerson value) {
	  ...
	  _SPWish.LOG.debug("updating suggestedBy from {} to {}", suggestedBy(), value);
  ...
  public void setSuggestedForRelationship(com.secretpal.model.SPPerson value) {
	  ...
	  _SPWish.LOG.debug("updating suggestedFor from {} to {}", suggestedFor(), value);
